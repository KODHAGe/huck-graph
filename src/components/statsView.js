    ...
    if (csvData.csvData) {
        ...
        accordionPanels = [
                ...
                content: (
                    <div className="sectionStart">
                        ...
                        <p>To summarize that a bit, you've logged
                            ...
                            <span className="bold"> {csvData.csvData.length - (splitData.diaper.length + splitData.feed.length + splitData.solids.length + splitData.sleep.length)}</span> other events.
                        </p>
            ...
            },
            {
                ...
                heading: "2. Food",
                content: (
                    <SectionFood data={splitData.allFoods} days={splitData.dateDiff} toplist={splitData.allFoods.toplist} solidtop={splitData.solids.toplist}></SectionFood>
                )
            },
            {
                id: "Potty",
        ...
        <div id="statsView">
            {csvData.csvData &&
                <div>
                    ...
                    <p>I've divided up the data and visualizations into tabs, you can move between them here:</p>
                    <Accordion
                        asTabs={!isMobile}
